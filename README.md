...
Um das Git-Repository `https://github.com/ftwegner/ChurchTools` auf deinen Windows-Rechner zu klonen, folge diesen Schritten:
...
5. **Virtuelle Python Umngebung erstellen**:
   ```
   python -m venv .venv
   .\.venv\Scripts\activate
   pip install -r requirements.txt
   ```
Das Repository ist jetzt auf deinem Rechner verfügbar. Du kannst es in Visual Studio Code öffnen oder weitere Git-Befehle ausführen.
